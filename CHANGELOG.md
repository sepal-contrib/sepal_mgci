...
- restore RSA latitude correction
- make the real surface area image scale-invariant
- read DEM neighbours before clipping to the AOI
- use the DEM cell's true E-W and N-S sizes in the real surface area

### Refactor

- drop dead nominalScale max
...
- replace removed pkg_resources with importlib.resources and pin pygaul<0.4 (#80)
